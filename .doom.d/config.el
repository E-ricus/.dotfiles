...
(setq user-full-name "Ericus"
      user-mail-address "eric.david2333@gmail.com")
...
;; KEY BINDINGS
(map! :leader
      :desc "Toogle actions"  "a" 'lsp-ui-sideline-apply-code-actions)

(map! :leader
      :desc "Go to reference"  "r" 'lsp-find-references)

...
local package_path_str = "/home/ericus/.cache/nvim/packer_hererocks/2.1.0-beta3/share/lua/5.1/?.lua;/home/ericus/.cache/nvim/packer_hererocks/2.1.0-beta3/share/lua/5.1/?/init.lua;/home/ericus/.cache/nvim/packer_hererocks/2.1.0-beta3/lib/luarocks/rocks-5.1/?.lua;/home/ericus/.cache/nvim/packer_hererocks/2.1.0-beta3/lib/luarocks/rocks-5.1/?/init.lua"
local install_cpath_pattern = "/home/ericus/.cache/nvim/packer_hererocks/2.1.0-beta3/lib/lua/5.1/?.so"
...
_G.packer_plugins = {
  ...
  ["cmp-buffer"] = {
    loaded = true,
    path = "/home/ericus/.local/share/nvim/site/pack/packer/start/cmp-buffer"
  },
  ["cmp-nvim-lsp"] = {
    loaded = true,
    path = "/home/ericus/.local/share/nvim/site/pack/packer/start/cmp-nvim-lsp"
  },
  ["cmp-nvim-lua"] = {
    loaded = true,
    path = "/home/ericus/.local/share/nvim/site/pack/packer/start/cmp-nvim-lua"
  },
  ["cmp-path"] = {
    loaded = true,
  ...
  ["express_line.nvim"] = {
    loaded = true,
    path = "/home/ericus/.local/share/nvim/site/pack/packer/start/express_line.nvim"
  },
  ["friendly-snippets"] = {
    loaded = true,
  ...
  ["glow.nvim"] = {
    loaded = true,
    path = "/home/ericus/.local/share/nvim/site/pack/packer/start/glow.nvim"
  },
  ["green_light.nvim"] = {
    loaded = true,
  ...
  ["impatient.nvim"] = {
    loaded = true,
    path = "/home/ericus/.local/share/nvim/site/pack/packer/start/impatient.nvim"
  },
  ["lsp-status.nvim"] = {
    loaded = true,
  ...
  neogit = {
    loaded = true,
    path = "/home/ericus/.local/share/nvim/site/pack/packer/start/neogit"
  },
  ["nvim-cmp"] = {
    loaded = true,
    path = "/home/ericus/.local/share/nvim/site/pack/packer/start/nvim-cmp"
  },
  ["nvim-colorizer.lua"] = {
    loaded = true,
  ...
  ["trouble.nvim"] = {
    config = { "\27LJ\2\nU\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\2\17auto_preview\2\14auto_fold\2\nsetup\ftrouble\frequire\0" },
    loaded = true,
    path = "/home/ericus/.local/share/nvim/site/pack/packer/start/trouble.nvim"
  },
  ["vim-highlightedyank"] = {
    loaded = true,
